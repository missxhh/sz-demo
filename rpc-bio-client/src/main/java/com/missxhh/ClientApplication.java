...
import com.missxhh.server.ServerDiscover;
...
public class ClientApplication {
    ...
    private static void addOrder() {
        ...
        // 添加订单
        IOrderService orderService = ServerDiscover.getRemoteProxyServer(IOrderService.class);
        orderService.addOrder(order);
        // 扣减库存
        IStoreService storeService = ServerDiscover.getRemoteProxyServer(IStoreService.class);
        storeService.deleteGoods(1L);
        // 推送短信消息
        ISmsService smsService = ServerDiscover.getRemoteProxyServer(ISmsService.class);
